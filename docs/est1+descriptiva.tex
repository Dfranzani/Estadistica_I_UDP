...
\hypertarget{variable-uniforme}{%
\subsection{Variable Uniforme}\label{variable-uniforme}}

\hypertarget{variable-bernoulli}{%
\subsection{Variable Bernoulli}\label{variable-bernoulli}}

\hypertarget{variable-binomial}{%
\subsection{Variable Binomial}\label{variable-binomial}}

\hypertarget{variable-poisson}{%
\subsection{Variable Poisson}\label{variable-poisson}}

\hypertarget{variable-aleatoria-continua}{%
\section{Variable aleatoria continua}\label{variable-aleatoria-continua}}

\hypertarget{variable-uniforme-1}{%
\subsection{Variable Uniforme}\label{variable-uniforme-1}}

\hypertarget{variable-exponencial}{%
\subsection{Variable Exponencial}\label{variable-exponencial}}

\hypertarget{variable-normal}{%
\subsection{Variable Normal}\label{variable-normal}}

\hypertarget{variable-t---student}{%
\subsection{Variable T - Student}\label{variable-t---student}}

\hypertarget{variable-ji---cuadrado}{%
\subsection{Variable Ji - Cuadrado}\label{variable-ji---cuadrado}}
...
\hypertarget{varianza-de-una-variable-aleatoria-discreta}{%
\subsection{Varianza de una variable aleatoria discreta}\label{varianza-de-una-variable-aleatoria-discreta}}

\hypertarget{varianza-de-una-variable-aleatoria-continua}{%
\subsection{Varianza de una variable aleatoria continua}\label{varianza-de-una-variable-aleatoria-continua}}
