...
\date{Actualizado al 12-02-2023}
...
\tightlist
\item
  Elegir un estudiante que está dentro de tu sala de clases (en este momento).
\item
  Pedir una orden (plato de fondo más entrada) en un local de comida, en cuyo menú tienen dos opciones de platos de fondo y dos de entradas.
\item
\item
\end{enumerate}
...
\hypertarget{probabilidad-de-un-evento}{%
\subsection{Probabilidad de un evento}\label{probabilidad-de-un-evento}}
...
\tightlist
\item
  Se lanza un dado de 6 caras una vez.
\item
...
La variable número de autos que pasan por un cruce en un tiempo determinado, es del tipo \ldots{}
La variable estatura se mueve en un rango de valores determinado por el mínimo y el máximo de la población, es del tipo \ldots{}
...
\hypertarget{distribuciuones}{%
\subsection{Distribuciuones}\label{distribuciuones}}
