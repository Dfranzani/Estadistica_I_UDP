...
\section*{Modalidad de trabajo}\label{modalidad-de-trabajo}}
\addcontentsline{toc}{section}{Modalidad de trabajo}
...
\tightlist
\item
  Obtenga el promedio de la variable (columna) \textbf{Open}. Interprete.
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Luego restamos el valor máximo con le mínimo}
...
\tightlist
\item
  Obtener el rango del resto de variables (ignore la variable fecha)
\end{enumerate}
...
Una forma de resumir las desviaciones sería sumando todas ellas. Sin embargo, es una mala idea, ya que la suma siempre es cero \eqref{eq:sumadesviaciones}, ¿alguna idea del por qué?
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Al calcular la varianza, se observa que la tasa de cierre es levemente menor}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Al calcular la desviación estándar, se observa que la tasa de cierre tiene menor}
\CommentTok{\# variabilidad que la tasa de apertura.}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ datos, }\CommentTok{\# Base de datos a utilizar}
       \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Close)) }\SpecialCharTok{+} \CommentTok{\# Comando estético para señalar la variable a graficar y en que eje}
  \FunctionTok{geom\_histogram}\NormalTok{(}\AttributeTok{bins =} \DecValTok{13}\NormalTok{, }\AttributeTok{color =} \StringTok{"white"}\NormalTok{, }\AttributeTok{fill =} \StringTok{"darkred"}\NormalTok{, }\AttributeTok{closed =} \StringTok{"left"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Histograma EUR/USD"}\NormalTok{, }\AttributeTok{x =} \StringTok{"Tasa de cierre"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Frecuencia"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{est1+descriptiva_files/figure-latex/unnamed-chunk-12-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ datos, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ Close)) }\SpecialCharTok{+} 
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Caja EUR/USD"}\NormalTok{, }\AttributeTok{x =} \StringTok{"Tasa de cierre"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Dispersión/Cuantiles"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{est1+descriptiva_files/figure-latex/unnamed-chunk-14-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{g }\OtherTok{=} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ datos, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \DecValTok{1}\NormalTok{, }\AttributeTok{y =}\NormalTok{ Close)) }\SpecialCharTok{+} 
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Violín EUR/USD"}\NormalTok{, }\AttributeTok{x =} \StringTok{""}\NormalTok{, }\AttributeTok{y =} \StringTok{"Tasa de cierre"}\NormalTok{) }\SpecialCharTok{+} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{datos}\SpecialCharTok{$}\NormalTok{Close2 }\OtherTok{=} \FunctionTok{ifelse}\NormalTok{(datos}\SpecialCharTok{$}\NormalTok{Close }\SpecialCharTok{\textgreater{}} \FloatTok{1.1}\NormalTok{, }\StringTok{"Mayor a 1.1"}\NormalTok{, }\StringTok{"Menor a  1.1"}\NormalTok{)}
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ datos,}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Close2)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_bar}\NormalTok{(}\AttributeTok{fill =} \StringTok{"darkgreen"}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Barras EUR/USD"}\NormalTok{, }\AttributeTok{x =} \StringTok{"Tasa de cierre"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Frecuencia"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ datos, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Open, }\AttributeTok{y =}\NormalTok{ Close)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Dispersión EUR/USD"}\NormalTok{, }\AttributeTok{x =} \StringTok{"Tasa de apertura"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Tasa de cierre"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
