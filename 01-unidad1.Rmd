...
#### Varianza y desviación estándar {.unnumbered}
...
## Notación poblacional y muestral {.unnumbered .unlisted}
...
::: {.exercise}
Utilizando la variable **Low** de la base de datos de la unidad, elabore un histograma y obtenga la tabla de frecuencias asociada. Interprete.
:::
...
::: {.exercise}
Utilizando la variable **Open** de la base de datos de la unidad, elabore un gráfico de caja. Interprete.
:::
...
::: {.exercise}
Utilizando las variables **Low** y **Open** de la base de datos de la unidad, elabore un gráfico violín incluyendo un gráfico de caja y el promedio para cada una. Interprete.
:::
...
::: {.exercise}
Utilizando las variables **Low** y **Open** de la base de datos de la unidad, elabore un gráfico violín incluyendo un gráfico de caja y el promedio para cada una, diferencia por año. Compara e interprete cada variable por separado.
:::
...
::: {.exercise}
Utilizando las variables **High** y **Open** de la base de datos de la unidad, elabore un gráfico de barras para cada una. Interprete.
:::
...
::: {.exercise}
Utilizando las variables **High** y **Low** de la base de datos de la unidad, elabore un gráfico de dispersión. Interprete.
:::
...
5.  Grafique el valor el valor promedio de la tasa más alta versus la más baja del EUR/USD para cada uno de los años. Interprete.
