...
g1 = g + # Creamos un nuevo gráfico a partir del anterior
  scale_y_continuous(breaks = values, labels = values) # Modificamos los valores mostrados en el eje de valores
library(gridExtra)
grid.arrange(g, g1, ncol = 2) # Desplegamos lo gráficos en la misma ventana
```
